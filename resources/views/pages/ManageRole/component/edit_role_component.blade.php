              ...
              <div class="box-body">
                <div class="form-group col-md-6">
                  <span class="has-float-label">
                      <input class="form-control" id="first" type="text" placeholder="Role Name" name="rolename" value="{{ $data->role_name }}" required/>
                <label for="first">Role Name</label>
                  </span>
                </div>
                <div class="form-group col-md-6">
                  <span class="has-float-label">
                      <input class="form-control" id="second" type="text" placeholder="Description" name="roledesc" value=" {{ $data->role_descriptions }}" required/>

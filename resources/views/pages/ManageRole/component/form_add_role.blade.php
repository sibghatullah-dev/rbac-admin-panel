      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/register_role" method="post" enctype="multipart/form-data">
                @csrf
              <div class="box-body">
                <div class="form-group col-md-6">
                  <span class="has-float-label">
                <input class="form-control" id="first" type="text" placeholder="Organization Name" name="rolename" required/>
                <label for="first">Role Name</label>
                  </span>
                </div>
                <div class="form-group col-md-6">
                  <span class="has-float-label">
                <input class="form-control" id="second" type="text" placeholder="Description" name="roledesc" required/>
            <label for="second">Role Description</label>
                ...
                <button type="submit" class="btn btn-info btn-lg">Add Role </button>
